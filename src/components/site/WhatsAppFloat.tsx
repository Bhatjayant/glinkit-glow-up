...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed right-4 top-1/2 z-50 grid h-14 w-14 -translate-y-1/2 place-items-center rounded-full bg-[#25D366] shadow-[var(--shadow-elegant)] ring-1 ring-black/10 transition-transform hover:scale-105"
    >
